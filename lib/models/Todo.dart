...
class Todo extends Model {
  ...
  const Todo._internal({required this.id, required name, description, required isCompleted, createdAt, updatedAt}): _name = name, _description = description, _isCompleted = isCompleted, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Todo({String? id, required String name, String? description, required bool isCompleted}) {
  ...
  Todo copyWith({String? name, String? description, bool? isCompleted}) {
    return Todo._internal(
      id: id,
      name: name ?? this.name,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'description': _description, 'isCompleted': _isCompleted, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'name': _name, 'description': _description, 'isCompleted': _isCompleted, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
